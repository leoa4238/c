...
int main() {
	...
	*/
	...
	printf("내 이니셜은 %c%c%c 입니다", i1, i2, i3);*/

	/*
		 실습2
		 세 과목의 점수를 입력받아 총점, 평균을 구하고 출력
	...
	*/
	...
	/*
		 ...
		 조건식이 참이면 if 내부의 코드를 실행 한 후 다음 코드 진행
		 조건식이 거짓이면 if문 전체를 건너뛰고 다음 코드를 진행

		    *모든 제어문은 기본적으로 중괄호를 이용하여 실행 될 코드를 분류
			 
			 실행 될 코드가 한 줄이라면 중괄호를 사용하지 않아도 
			 실행될 코드 인식
	*/
	//int n1, n2;
	...
	/*int su1, su2;
	printf("숫자 두개 입력 :"); scanf_s("%d %d", &su1, &su2);
	...
	*/
    ...
    /*
		...
		조건2. 입력된 각 숫자는 서로 다른 변수에 저장
	*/
	/*int su1, su2, su3;
	printf("숫자 세개 입력 :"); scanf_s("%d %d %d", &su1, &su2, &su3);
